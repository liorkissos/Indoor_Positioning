...
Kalman: 
1) Kalman: pure linear Kalman filter. input is synthetic (not the col.txt file)
...
5) Trilateration_PF under actual: main file. positioning based on PF whose input is the recorded file. 

all simulations are workig well. Particle Filtering may require further investigation. mainl the choice of q(x) (see Indoor Pos PF.docx)